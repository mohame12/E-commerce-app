          ...
          if(state.state)
            {
              ...
              LoginCubit.get(context).getHomeTapItem(token: UserDataFromStorage.userId);
              LoginCubit.get(context).getfavorit(token: UserDataFromStorage.userId);
              LoginCubit.get(context).getProfile(token: UserDataFromStorage.userId);
